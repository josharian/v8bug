...
module.exports = {
  ...
  getBackendState: getBackendState, getElementIds: getElementIds, getClock: getClock,
...
module.exports = {
  ...
  getMissingChanges: getMissingChanges, equals: equals, getHistory: getHistory, uuid: uuid,
...
var _arr = ['canUndo', 'canRedo', 'getObjectId', 'getObjectById', 'getActorId', 'setActorId', 'getConflicts', 'getClock', 'Text', 'Table', 'Counter'];
for (var _i = 0; _i < _arr.length; _i++) {
  var name = _arr[_i];
...
var Connection = function () {
  ...
  _createClass(Connection, [{
    ...
    value: function maybeSendChanges(docId) {
      ...
      var state = Frontend.getBackendState(doc);
      var clock = fromJS(Frontend.getClock(doc));
